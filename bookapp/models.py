...
class Book(models.Model):
    ...
    borrower = models.ForeignKey(User,verbose_name=_('借阅者'),on_delete=models.CASCADE, blank=True, null=True)
...
class UserProfile(models.Model):
    class Meta:
        verbose_name = _('用户信息')
        verbose_name_plural = verbose_name
    user = models.OneToOneField(User, blank=True, null=True,related_name='user',on_delete=models.CASCADE)
